...
use App\Http\Controllers\Api\App\AppVersionController;
...
Route::get(
    '/payout-evidence/{payout}/iban-proof',
    [PayoutAdminController::class, 'downloadProof'],
)
    ->middleware(['signed', 'throttle:60,1'])
    ->whereNumber('payout')
    ->name('api.admin.payout-proof.download');
    ...
    */
    ...
    Route::prefix('admin')->group(function () {
        ...
        */
        ...
        /* Standalone payments register. Keep separate from wallets. */
        Route::get('/payments/export', [AdminPaymentController::class, 'export']);
        Route::get('/payments', [AdminPaymentController::class, 'index']);
        Route::post('/payments/manual', [AdminPaymentController::class, 'storeManual']);
        Route::patch('/payments/{payment}/refund', [AdminPaymentController::class, 'refund'])
            ->whereNumber('payment');
        Route::get('/payment-gateways', [AdminPaymentController::class, 'gateways']);
        Route::patch('/payment-gateways/{provider}/status', [AdminPaymentController::class, 'updateGatewayStatus'])
