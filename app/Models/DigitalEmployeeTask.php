...
class DigitalEmployeeTask extends Model
{
    ...
    {
        return ['input' => 'array', 'output' => 'array', 'scheduled_at' => 'datetime', 'started_at' => 'datetime', 'completed_at' => 'datetime', 'cancelled_at' => 'datetime'];
    }

    public function employee(): BelongsTo
    {
        return $this->belongsTo(DigitalEmployee::class, 'digital_employee_id');
    }

    public function events(): HasMany
    {
        return $this->hasMany(DigitalTaskEvent::class);
    }
}
