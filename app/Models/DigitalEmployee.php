...
class DigitalEmployee extends Model
{
    ...
    {
        return ['requires_approval' => 'boolean', 'capabilities' => 'array', 'permissions' => 'array', 'kpis' => 'array', 'monthly_budget' => 'decimal:2', 'spent_this_month' => 'decimal:2', 'last_run_at' => 'datetime'];
    }

    public function tasks(): HasMany
    {
        return $this->hasMany(DigitalEmployeeTask::class);
    }
